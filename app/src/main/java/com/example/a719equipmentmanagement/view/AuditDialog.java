...
public class AuditDialog extends QMUIDialogBuilder<AuditDialog> {
     ...
     */
    public AuditDialog setPlaceholder(String placeholder) {
     ...
     * 设置输入框的 placeholder
     */
    public AuditDialog setPlaceholder(int resId) {
        return setPlaceholder(getBaseContext().getResources().getString(resId));
    }

    public AuditDialog setDefaultText(CharSequence defaultText) {
     ...
     */
    public AuditDialog setTransformationMethod(TransformationMethod transformationMethod) {
     ...
     */
    public AuditDialog setInputType(int inputType) {
